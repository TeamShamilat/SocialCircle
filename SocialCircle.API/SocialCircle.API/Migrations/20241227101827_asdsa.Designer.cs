...
namespace SocialCircle.API.Migrations
{
    ...
    [Migration("20241227101827_asdsa")]
    partial class asdsa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialCircle.API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SocialCircle.API.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialCircle.API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialCircle.API.Models.RefreshToken", b =>
                {
                    b.HasOne("SocialCircle.API.Models.ApplicationUser", "User")
